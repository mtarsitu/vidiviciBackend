...
const UserApplication = ({ show, handleClose, user, mode, colors }) => {
            ...
            <Container component="main" maxWidth="s">
              ...
              >
                <Box component="form" noValidate sx={{ mt: 1 }}>
                  ...
                  <Typography component="p">
                    2. Aveti in prezent si preconizati ca veti avea si in viitor
                    un venit cert si sigur provenind de exemplu dintr-o
                    activitate remunerata, din onorarii, din cedarea folosintei
                    unor bunuri, din investitii, din pensii?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                      control={
                  ...
                  <Typography component="p">
                    ...
                    avansat de dezvoltare a activitatilor, inclusiv dar fara a
                    se limita la dezvoltarea de produs(e)/serviciu(ii) de
                  ...
                  <Typography component="p">
                    ...
                    profitul este modic sau angajarea unei investitii ce
                    presupune obtinerea unui profit semnificativ insa nu foarte
                    cert ca realizare?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                  ...
                  <Typography component="p">
                    ...
                    investitional: imi asum un risc de investitie pe termen
                    scurt anticipand realizarea unui profit considerabil pe
                    termen lung?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                  ...
                  <Typography component="p">
                    ...
                    investitii realizate? Ce interval de timp investitional
                    aveti in vedere?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                  ...
                  <Typography component="p">
                    8. Care ar fi masurile pe care le-ati adopta in cazul in
                    care investitia pe care ati facut-o intr-o societate de tip
                    start-up si/sau intr-o societate care se afla intr-un stadiu
                    incipient sau partial avansat de dezvoltare a activitatilor,
                  ...
                  <Typography component="p">
                    ...
                    (inserati procentul alegand din optiunile de mai jos) din
                    sumele pe care intentionez sa le investesc in relatia cu
                    Vidi Vici Afia srl, inclusiv castigurile generate din
                    aceasta relatie, pentru a acoperi cheltuielile
                  ...
                  <Typography component="p">
                    10. Ce tip de investitii ati realizat in trecut, in ce fel
                    de produse, care este experienta dumneavoastra
                    investitionala cu astfel de produse si care este gradul de
                    cunoastere al riscurilor aferente acestor produse?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                      control={
                  ...
                  <Typography component="p">
                    11. Cate tranzactii de investitii realizati in general in
                    cursul unui an, indiferent ca este vorba despre investitii
                    precum cele in produse cu venit fix, actiuni, unitati de
                    fond, instrumente financiare derivate, actiuni/parti
                    sociale/parti de interes in societati nelistate?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="11-1"
                          disabled
                          checked={applicationAnswer[11][1]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="11-2"
                          disabled
                          checked={applicationAnswer[11][2]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="11-3"
                          disabled
                          checked={applicationAnswer[11][3]}
                        />
                      }
                      label="mai putin de 10;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="11-4"
                          disabled
                          checked={applicationAnswer[11][4]}
                        />
                      }
                      label="niciuna."
                    />
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="12-1"
                          disabled
                          checked={applicationAnswer[12][1]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="12-2"
                          disabled
                          checked={applicationAnswer[12][2]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="12-3"
                          disabled
                          checked={applicationAnswer[12][3]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="12-4"
                          disabled
                          checked={applicationAnswer[12][4]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="12-5"
                          disabled
                          checked={applicationAnswer[12][5]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="12-6"
                          disabled
                          checked={applicationAnswer[12][6]}
                        />
                      }
                  ...
                  <Typography component="p">
                    ...
                    dumneavoastra de investitii, indiferent ca este vorba despre
                    investitii precum cele in produse cu venit fix, actiuni,
                    unitati de fond, instrumente financiare derivate,
                    actiuni/parti sociale/parti de interes in societati
                    nelistate, depozite bancare, bunuri imobile?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="13-1"
                          disabled
                          checked={applicationAnswer[13][1]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="13-2"
                          disabled
                          checked={applicationAnswer[13][2]}
                        />
                      }
                      label="intre 50.000 Euro si 100.000 Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="13-3"
                          disabled
                          checked={applicationAnswer[13][3]}
                        />
                      }
                      label="intre 30.000 Euro si 50.000 Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="13-4"
                          disabled
                          checked={applicationAnswer[13][4]}
                        />
                      }
                      label="intre 10.000 Euro si 30.000 Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="13-5"
                          disabled
                          checked={applicationAnswer[13][5]}
                        />
                      }
                      label="mai putin de 10.000 de Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="13-6"
                          disabled
                          checked={applicationAnswer[13][6]}
                        />
                      }
                  ...
                  <Typography component="p">
                    ...
                    sociale, parti de interes emise de societati inchise
                    (nelistate) si a caror activitate era de tip start-up sau se
                    afla intr-un stadiu incipient sau partial avansat de
                    dezvoltare, inclusiv dar fara a se limita la dezvoltarea
                    unui/unor produs(e)/serviciu(ii) de interes pentru
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="14-1"
                          disabled
                          checked={applicationAnswer[14][1]}
                        />
                      }
                      label="100.000 Euro sau mai mult;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="14-2"
                          disabled
                          checked={applicationAnswer[14][2]}
                        />
                      }
                      label="intre 50.000 Euro si 100.000 Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="14-3"
                          disabled
                          checked={applicationAnswer[14][3]}
                        />
                      }
                      label="intre 30.000 Euro si 50.000 Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="14-4"
                          disabled
                          checked={applicationAnswer[14][4]}
                        />
                      }
                      label="intre 10.000 Euro si 30.000 Euro;"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="14-5"
                          disabled
                          checked={applicationAnswer[14][5]}
                        />
                      }
                      label="mai putin de 10.000 de Euro;"
                    />
                  ...
                  <Typography component="p">
                    15. Posedati experienta profesionala, prezenta sau trecuta,
                    de cel putin 1 an in materie de investitii precum cele in
                    produse cu venit fix, actiuni, unitati de fond, instrumente
                    financiare derivate, actiuni/parti sociale/parti de interes
                    in societati nelistate sau in sectorul financiar sau intr-o
                    profesie reglementata (e.g. avocat, consultant financiar,
                    contabil) care acorda incidental consultanta de investitii?
                  </Typography>
                  <FormGroup sx={{ marginLeft: 3 }}>
                    <FormControlLabel
                      control={
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="15-3"
                          disabled
                          checked={applicationAnswer[15][3]}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          id="16-3"
                          disabled
                          checked={applicationAnswer[16][3]}
                        />
                      }
                      label="nu posed experienta profesionala in niciunul dintre domeniile mentionate."
                    />
