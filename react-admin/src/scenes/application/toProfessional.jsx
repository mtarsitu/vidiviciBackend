              ...
              <Box component="form" noValidate sx={{ mt: 1 }}>
                ...
                {section === 1 && (
                  <>
                    ...
                    <Typography component="p">
                      ...
                      viitor un venit cert si sigur provenind de exemplu dintr-o
                      activitate remunerata, din onorarii, din cedarea
                      folosintei unor bunuri, din investitii, din pensii?
                    </Typography>
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                        control={
                    ...
                    <Typography component="p">
                      ...
                      partial avansat de dezvoltare a activitatilor, inclusiv
                      dar fara a se limita la dezvoltarea de
                      produs(e)/serviciu(ii) de interes pentru realizarea unei
                      investitii?
                    </Typography>
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                  ...
                  "
                    ...
                    <Typography component="p">
                      ...
                      investitii, chiar daca profitul este modic sau angajarea
                      unei investitii ce presupune obtinerea unui profit
                ...
                {section === 2 && (
                  <>
                    ...
                    <Typography component="p">
                      7. Ce orizont de timp aveti in vedere pentru mentinerea
                      unei investitii realizate? Ce interval de timp
                      investitional aveti in vedere?
                    </Typography>
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                        control={
                    ...
                    <Typography component="p">
                      ...
                      care investitia pe care ati facut-o intr-o societate de
                      tip start-up si/sau intr-o societate care se afla intr-un
                      stadiu incipient sau partial avansat de dezvoltare a
                      activitatilor, ar scadea intr-un an cu 20%?
                    </Typography>
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                        control={
                ...
                {section === 3 && (
                  <>
                    ...
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                        control={
                          <Checkbox id="10-1-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-1-2" onClick={handleFormObject} />
                          }
                          label="< 2 ani ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-1-3" onClick={handleFormObject} />
                          }
                          label=" ≥ 2 ani"
                        />
                      </FormGroup>
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-1-4" onClick={handleFormObject} />
                          }
                          label="da ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-1-5" onClick={handleFormObject} />
                          }
                          label="nu"
                        />
                      </FormGroup>
                      <FormControlLabel
                        control={
                          <Checkbox id="10-2-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-2-2" onClick={handleFormObject} />
                          }
                          label="< 2 ani ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-2-3" onClick={handleFormObject} />
                          }
                          label=" ≥ 2 ani"
                        />
                      </FormGroup>
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-2-4" onClick={handleFormObject} />
                          }
                          label="da ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-2-5" onClick={handleFormObject} />
                          }
                          label="nu"
                        />
                      </FormGroup>
                      <FormControlLabel
                        control={
                          <Checkbox id="10-3-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-3-2" onClick={handleFormObject} />
                          }
                          label="< 2 ani ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-3-3" onClick={handleFormObject} />
                          }
                          label=" ≥ 2 ani"
                        />
                      </FormGroup>
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-3-4" onClick={handleFormObject} />
                          }
                          label="da ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-3-5" onClick={handleFormObject} />
                          }
                          label="nu"
                        />
                      </FormGroup>
                      <FormControlLabel
                        control={
                          <Checkbox id="10-4-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-4-2" onClick={handleFormObject} />
                          }
                          label="< 2 ani ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-4-3" onClick={handleFormObject} />
                          }
                          label=" ≥ 2 ani"
                        />
                      </FormGroup>
                      <FormGroup sx={{ marginLeft: 5 }}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox id="10-4-4" onClick={handleFormObject} />
                          }
                          label="da ;"
                        />
                        <FormControlLabel
                          control={
                            <Checkbox id="10-4-5" onClick={handleFormObject} />
                          }
                          label="nu"
                        />
                      </FormGroup>
                ...
                {section === 4 && (
                  <>
                    ...
                    <Typography component="p">
                      ...
                      parti sociale, parti de interes emise de societati inchise
                      (nelistate) si a caror activitate era de tip start-up sau
                      se afla intr-un stadiu incipient sau partial avansat de
                ...
                {section === 5 && (
                  <>
                    <Typography component="p">
                      ...
                      trecuta, de cel putin 1 an in materie de investitii precum
                      cele in produse cu venit fix, actiuni, unitati de fond,
                      instrumente financiare derivate, actiuni/parti
                      sociale/parti de interes in societati nelistate sau in
                      sectorul financiar sau intr-o profesie reglementata (e.g.
                      avocat, consultant financiar, contabil) care acorda
                      incidental consultanta de investitii?
                    </Typography>
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                        control={
                          <Checkbox id="15-1-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox id="15-2-1" onClick={handleFormObject} />
                        }
                    ...
                    <FormGroup sx={{ marginLeft: 3 }}>
                      <FormControlLabel
                        control={
                          <Checkbox id="16-1-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox id="16-2-1" onClick={handleFormObject} />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox id="16-3" onClick={handleFormObject} />
                        }
                        label="nu posed experienta profesionala in niciunul dintre domeniile mentionate."
                      />
                    </FormGroup>
