...
const ToProfesional = () => {
  ...
  const handleFormObject = (e) => {
    ...
    console.log(formObject[1].b);
    formObject[1].b = e.target.checked;
    console.log(formObject[1].b);
            ...
            {section === 1 && (
              <>
                ...
                <FormGroup sx={{ marginLeft: 3 }}>
                  ...
                  />
                  <FormControlLabel
                    control={<Checkbox id="1b" onClick={handleFormObject} />}
              ...
              "
                ...
                <Typography component="p">
                  ...
                  un venit cert si sigur provenind de exemplu dintr-o activitate
            ...
            {section === 4 && (
              <>
                ...
                <Typography component="p">
                  ...
                  investitii realizate? Ce interval de timp investitional aveti
                  in vedere?
                </Typography>
                <FormGroup sx={{ marginLeft: 3 }}>
            ...
            {section === 5 && (
              <>
                <Typography component="p">
                  ...
                  investitia pe care ati facut-o intr-o societate de tip
                ...
                <Typography component="p">
                  ...
                  sumele pe care intentionez sa le investesc in relatia cu Vidi
                  Vici Afia srl, inclusiv castigurile generate din aceasta
                  relatie, pentru a acoperi cheltuielile
            ...
            {section === 7 && (
              <>
                <Typography component="p">
                  ...
                  precum cele in produse cu venit fix, actiuni, unitati de fond,
                  instrumente financiare derivate, actiuni/parti sociale/parti
            ...
            {section === 8 && (
              <>
                <Typography component="p">
                  ...
                  actiuni/parti sociale/parti de interes in societati nelistate,
                  depozite bancare, bunuri imobile?
                </Typography>
                <FormGroup sx={{ marginLeft: 3 }}>
                  <FormControlLabel
                    control={<Checkbox />}
                ...
                <Typography component="p">
                  ...
                  unui/unor produs(e)/serviciu(ii) de interes pentru realizarea
                  unei investitii?
                </Typography>
                <FormGroup sx={{ marginLeft: 3 }}>
                  <FormControlLabel
            ...
            {section === 9 && (
              <>
                <Typography component="p">
                  ...
                  reglementata (e.g. avocat, consultant financiar, contabil)
                  care acorda incidental consultanta de investitii?
                </Typography>
                <FormGroup sx={{ marginLeft: 3 }}>
                  <FormControlLabel
                    control={<Checkbox />}
