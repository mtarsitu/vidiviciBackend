       ...
       public static IEnumerable<Investment> GetInvestments()
       {
           return new List<Investment>
           {
               ...
               new Investment{
                    ...
                    ClientId= "2fe873ad-9a4a-4a42-8acf-b3da45e275cc",
                    FundId =1,
                    RateOnFinal=true,
               ...
               new Investment{
                    DateAproved = DateTime.UtcNow,
                    ClientId= "ae91b432-a7d6-4442-a1de-34abec0fdd3f",
                    FundId =2,
       ...
       public async static void SetUsers(UserManager<User> userManager){
        ...
        internal static IEnumerable<Information> GetInformations()
        {
            return new List<Information>{
                new Information{
                    UserId = "ae91b432-a7d6-4442-a1de-34abec0fdd3f",
                    Cnp = "5020116210753",
                 ...
                 new Information{
                    UserId = "2fe873ad-9a4a-4a42-8acf-b3da45e275cc",
                    Cnp = "5020116210753",
                 ...
                 new Information{
                    UserId = "e1c6b139-aa89-47dc-a9c5-35bba184fdc4",
                    Cnp = "5020116210753",
