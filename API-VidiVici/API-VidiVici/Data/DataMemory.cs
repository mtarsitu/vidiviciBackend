...
namespace API_VidiVici.Data
{
    public static class DataMemory
   {
       ...
       public static IEnumerable<Investment> GetInvestments()
       {
           ...
           {
               new Investment{
                   ClientId= "7353e2ac-e046-4bc7-a9ae-444acc222ebd",
                   FundId =1,
                   RateOnFinal=true,
               ...
               new Investment{
                   ClientId= "d2cb08bb-30de-4335-aa33-75927da7e0af",
                   FundId =2,
       ...
       public async static void SetUsers(UserManager<User> userManager){
        ...
        internal static IEnumerable<Information> GetInformations()
        {
            return new List<Information>{
                new Information{
                    UserId = "7353e2ac-e046-4bc7-a9ae-444acc222ebd",
                    Cnp = "5020116210753",
                 ...
                 new Information{
                    UserId = "d2cb08bb-30de-4335-aa33-75927da7e0af",
                    Cnp = "5020116210753",
                    BirthDate = DateTime.UtcNow,
