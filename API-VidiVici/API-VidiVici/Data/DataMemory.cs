    ...
    public static class DataMemory
   {
       ...
       public static IEnumerable<Investment> GetInvestments()
       {
           return new List<Investment>
           {
               ...
               new Investment{
                   ClientId= "2877d259-e8ff-41f8-9524-b0ad17162be4",
                   FundId =1,
                   RateOnFinal=true,
               ...
               new Investment{
                   ClientId= "8ec48e0a-7539-48e2-a35b-f45b032cd181",
                   FundId =2,
       ...
       public async static void SetUsers(UserManager<User> userManager){
        ...
        internal static IEnumerable<Information> GetInformations()
        {
            return new List<Information>{
                new Information{
                    UserId = "8ec48e0a-7539-48e2-a35b-f45b032cd181",
                    Cnp = "5020116210753",
                 ...
                 new Information{
                    UserId = "2877d259-e8ff-41f8-9524-b0ad17162be4",
                    Cnp = "5020116210753",
                 ...
                 new Information{
                    UserId = "fa0df2e8-7bd2-4343-ba2c-c6b3878a30ed",
                    Cnp = "5020116210753",
