...
namespace API_VidiVici.Data
{
    public static class DataMemory
   {
       ...
       public static IEnumerable<Investment> GetInvestments()
       {
           ...
           {
               new Investment{
                   ClientId= "010487eb-5d17-4b8c-a09b-cdc38cb9a90a",
                   FundId =1,
                   RateOnFinal=true,
               ...
               new Investment{
                   ClientId= "7eec8294-bdfc-40f6-881c-a99ee15beaa1",
                   FundId =2,
       ...
       public async static void SetUsers(UserManager<User> userManager){
        ...
        internal static IEnumerable<Information> GetInformations()
        {
            return new List<Information>{
                new Information{
                    UserId = "010487eb-5d17-4b8c-a09b-cdc38cb9a90a",
                    Cnp = "5020116210753",
                 ...
                 new Information{
                    UserId = "7eec8294-bdfc-40f6-881c-a99ee15beaa1",
                    Cnp = "5020116210753",
                    BirthDate = DateTime.UtcNow,
